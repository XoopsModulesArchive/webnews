...
/*
Web-News v.1.5.5 NNTP<->WWW gateway
...
function uuencode($in)
{
    ...
    for ($i = 0, $j = mb_strlen($in); $i < $j; $i += 3) {
        if (0 == ($i % 45)) {
            if (($j - $i) > 45) {
                $out .= "\n" . chr(0x20 + 45);
            } else {
